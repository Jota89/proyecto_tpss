...
(function ($) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    $('body .sidecart-data').append(
      '<form><table class="table table-hover  ' + idCartTable + '" id="' + idCartTable + '"></table></form>'
    );
    ...
    var drawTable = function () {
      ...
      $.each(products, function () {
        ...
        $cartTable.append(
          ...
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="form-control form-control-sm' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="text-right ' + classProductTotal + '">' + options.currencySymbol + MathHelper.getRoundedNumber(total) + '</td>' +
          '<td title="Remove from Cart" class="text-center" style="width: 30px;"><a href="javascript:void(0);" class="btn btn-sm ' + classProductRemove + '"><i class="fas fa-trash "></i></a></td>' +
          '</tr>'
        );
      });
