        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h1 class="m-0 font-weight-bold text-primary">Gestion de Empleados</h1>
                    <button type="button" id="createEmpleado" class="btn d-block float-right" data-toggle="modal" data-target="#ajaxModal"><i class="fas fa-user-plus"></i> Crear</button>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="empleados-table" class="table table-stripe">
                            <thead>
                            <tr>
                                <th scope="col">ID</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="empleadoForm" name="empleadoForm" class="formulario form-horizontal" >
                        @csrf
                        ...
                        <button id="saveEmpleado" class="btn btn-primary save">Guardar</button>
                        <button id="updateEmpleado" class="btn btn-primary save ">Actualizar Informacion</button>
                    </form>
                </div>
            </div>
        </div>
