        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h1 class="m-0 font-weight-bold text-primary">Gestion de Proveedores</h1>
                    <button type="button" id="createProveedor" class="btn d-block float-right" data-toggle="modal" data-target="#ajaxModal"><i class="fas fa-user-plus"></i> Crear</button>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="proveedores-table" class="table table-stripe">
                            <thead>
                            <tr>
                                <th scope="col">ID</th>
                                <th scope="col"><i class="fas fa-user"></i> Nombre</th>
                                <th scope="col"><i class="fas fa-at"></i> Apellido</th>
                                <th scope="col"><i class="fas fa-venus-mars"></i> Documento</th>
                                <th scope="col"><i class="fas fa-briefcase"></i> Telefono</th>
                                <th scope="col"><i class="fas fa-envelope"></i> Correo</th>
                                <th scope="col"><i class="fas fa-user"></i> Estado</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="ajaxModalLabel">Crear Proveedor</h2>
                ...
                <div class="modal-body">
                    ...
                    <form id="proveedorForm" name="proveedorForm" class="formulario form-horizontal" >
                        @csrf
                        ...
                        <button id="saveProveedor" class="btn btn-primary save">Guardar</button>
                        <button id="updateProveedor" class="btn btn-primary save ">Actualizar Informacion</button>
                    </form>
                </div>
            </div>
        </div>
